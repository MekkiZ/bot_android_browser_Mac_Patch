...
def AreWeFBLoggedIn(p_driver,p_udid):
    ...
    try:
        see_profile = p_driver.find_elements_by_xpath(
            "//android.view.ViewGroup[contains(@content-desc,'profil')]")
        ...
        mymodules.Scroll_Down(p_driver, p_udid)
    ...
    try:
        ...
        myprofile_username = mymodules.GetTextfromScreenshot(p_driver, p_udid, my_username_element[0])
        ...
        for FB_profile in list_FB_profiles:
            ...
            if not are_we_connected_FB:
                ...
                if quantity_actions > 0:
                    ...
                    p_function(p_udid, p_taskuser_id, p_driver, FB_username, quantity_actions,label_log,lock)
    ...
    while True:
        try:
            ...
            try:
                ...
                button_logout = p_driver.find_element_by_xpath("//android.view.ViewGroup[contains(@content-desc,'Log Out')]")
                button_logout.click()
...
def FBLogin(p_driver, p_profile,p_udid,label_log,lock):
    ...
    try:
        button_account = WebDriverWait(p_driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, f"//android.widget.ScrollView//android.widget.TextView[@text='{p_profile}']")))
...
def RunFaceBookApp(p_udid, p_function, p_taskuser_id,label_log,lock):
    ...
    if are_we_connected_FB:
        ...
        if quantity_actions > 0:
            ...
            # WE WILL RUN THE TASK FOR THIS PROFILE =============================================
            # ===================================================================================
            p_function(p_udid, p_taskuser_id, driver, FB_username, quantity_actions,label_log,lock)
...
def Smartphone_Cold_Messaging_Facebook_Group_Members_3(p_udid,p_taskuser_id,p_driver,FB_username,p_quantity_actions,label_log,lock):
    ...
    #mymodules.PopupMessage("ACTIONS", f"Facebook user {FB_username} can make {p_quantity_actions} actions now of Cold_Messaging_Facebook_Group_Members_3!")
    ...
    mymodules.DisplayMessageLogUI(label_log,
                                  ...
                                  "Black")
    mymodules.PopupMessage("Done", f"SMARTPHONE|||{p_udid}||{FB_username}| PhoneBot finished the automation Smartphone_Cold_Messaging_Facebook_Group_Members_3")
